...
if __name__ =='__main__':
    text = BeautifulSoup(html_fragment, 'html.parser')
    all_news = text.find_all('a')
    current_news = all_news[0]
    title = current_news.next
    href_link = current_news.previous.contents[0]['href']

    for similar_news in all_news[1:]:
        pass
